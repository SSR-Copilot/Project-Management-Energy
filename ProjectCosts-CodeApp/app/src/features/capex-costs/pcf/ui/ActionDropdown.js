...
export class ActionDropdown {
    ...
    show(e, recordId, hasComments) {
        ...
        const dropdownDot = this._dropdownElement.querySelector("#dropdown-comment-dot");
        if (dropdownDot) {
